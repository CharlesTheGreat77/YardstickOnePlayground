...
def main():
    ...
    parser.add_argument('-a', '--auto', help='Enable to automatically send captures/cap files / Use in conjunction with -rn/--rolljam to send the first signal automatically', action='store_true', required=False)
